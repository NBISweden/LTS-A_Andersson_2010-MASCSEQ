""" 
All code below is taken directly from the st-pipeline annotation.py and common/stats.py module.
"""

# From stpipeline.common.utils
def fileOk(_file):
    """
...
annotateReads(
    ...
    snakemake.params.strandedness,     # st-option: strandness (yes*[=forward]/no/reverse)
